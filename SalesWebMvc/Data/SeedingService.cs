...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            if(_context.Department.Any() || //metodo Any() verifica se tem dados no banco de dados
                _context.Seller.Any() ||
            ...
            //criando objetos e adicionando no banco de dados
            //lembrar de inserir o SeedingService na classe Startup.cs
            ...
            _context.Department.AddRange(d1, d2, d3, d4); //adiciona os objetos ao banco de dados

            _context.Seller.AddRange(s1, s2, s3, s4, s5, s6); //adiciona os objetos ao banco de dados

            _context.SalesRecord.AddRange( //adiciona os objetos ao banco de dados
